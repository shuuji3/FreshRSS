...
return array(
	...
	'import_export' => array(
		'export_no_zip_extension' => '現在サーバーにZIP拡張が存在しません。一つずつファイルをエクスポートしてみてください。',
		'feeds_imported' => 'フィードはインポート後に更新されます。',
		'feeds_imported_with_errors' => 'フィードはインポートされましたが、エラーが発生しました。',
		'file_cannot_be_uploaded' => 'ファイルをアップロードすることはできません！',
		'no_zip_extension' => '現在サーバーにZIP拡張が存在しません。',
